...
# use Python from homebrew, if installed
...
# ORNL PROXY SERVERS
# ssh/corkscrew is set up in ~/.ssh/config
# @see https://portal.ornl.gov/sites/ccsd/its/Pages/AccessingExternalSitesfromORNLthroughSSH_FTP_andRSYNCProxy.aspx
export RSYNC_PROXY=snowman.ornl.gov:3128
# export FTP_PROXY=snowman.ornl.gov:3128
